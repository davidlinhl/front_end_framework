...
<head>
	...
	<script src="https://cdn.bootcss.com/echarts/4.4.0-rc.1/extension/dataTool.js"></script>
	<script src="https://cdn.bootcss.com/echarts/4.4.0-rc.1/extension/bmap.js"></script>
	<!-- <script src="https://cdn.bootcss.com/echarts/4.4.0-rc.1/echarts.common.js"></script> -->
	<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=Kj9E7FTBKRUMXc48zGRt2DIg4N6Q6y2B"></script>
</head>
<body>
<?php
...
?>
	...
	<!-- <div id="chart4" style="width: 800;height:500px;"></div>
	<script type="text/javascript">
